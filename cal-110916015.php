...
<?php
 echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">';
	...
	<table  width="400" height="50" align="center" bgcolor="#f0ffff" border="3">
	<tr>
...
<!--計算機的按鍵們-->
<table width="400" height="300" align="center" bgcolor="#f0ffff" border="5">
<tr>
	<td align='center' valign="middle">
